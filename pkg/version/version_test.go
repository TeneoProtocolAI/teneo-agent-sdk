...
func TestGetVersion(t *testing.T) {
	...
	if !strings.Contains(version, "2.3.0") {
		t.Errorf("Expected version to contain '2.3.0', got: %s", version)
	}
}
...
func TestSemanticVersionComponents(t *testing.T) {
	...
	if Minor != 3 {
		t.Errorf("Expected Minor version to be 3, got: %d", Minor)
	}
...
func TestGetVersionString(t *testing.T) {
	...
	if !strings.Contains(versionString, "2.3.0") {
		t.Errorf("Version string should contain '2.3.0', got: %s", versionString)
	}
}
...
func TestGetFullVersionString(t *testing.T) {
	...
	if !strings.Contains(fullVersionString, "v2.3.0") {
		t.Errorf("Expected full version string to contain 'v2.3.0', got: %s", fullVersionString)
	}
}
...
func TestGetBanner(t *testing.T) {
	...
	if !strings.Contains(banner, "v2.3.0") {
		t.Error("Banner should contain 'v2.3.0'")
	}
}
...
func TestIsCompatible(t *testing.T) {
	tests := []struct {
		...
		{"same version", 2, 3, true},
		{"newer minor", 2, 4, false},
